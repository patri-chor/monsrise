...
- **Measured Duration**: 35.96s (Historical Baseline: 38.0s)
...
- **optimizer_no_op (no valid split/ig)**: 22
...
- **Optimization Duration**: 217.0s
- **Evaluation Duration**: 187.0s
