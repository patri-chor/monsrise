...
async function runT013Tests() {
  ...
  console.log('  ✓ 全部 T005~T026 任务规格与交付报告成对存在且非空。\n');
  ...
  const allExpectedFiles = [
    ...
    'T025-enforce-t024-runtime-implementation.md', 'T025.report.md',
    'T026-t025-executor-test-verification.md', 'T026.report.md',
  ];
