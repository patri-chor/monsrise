...
export class L1MeleeEvaluator {
  public static evaluateL1(
    targetEntry: DynamicPoolEntry,
    poolEntries: DynamicPoolEntry[],
    seeds: number[]
    ...
    const opponents = poolEntries.filter(e => e.formationId !== targetEntry.formationId && e.status === 'ACTIVE');
