import type { ObservableMatchResult, ObservableRoundOutput } from '../product_match_runner';
...
export function compareProductOutcome(a: ProductOutcome, b: ProductOutcome): number {
  ...
  if (a.targetL !== b.targetL) return b.targetL - a.targetL; // lower loss better

  // Aggregate round wins
  ...
  // Aggregate opponent HP (lower is better)
