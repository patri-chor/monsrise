...
export const DB_MONSTERS: MonsterData[] = [
  ...
  { id: 104, name: "散弹哥", cost: 2, type: 'ranged', hp: 1400, atk: 30, ats: 1.18, range: 5, speed: 2.5, skill: 'incendiary', skillCd: 3, race: "哥布林", role: "射手", sx: 619, sy: 20, sw: 204, sh: 190, skillCoeff: 3.0, skillDesc: "散弹：普攻散射五颗子弹；技能发射燃烧弹造成 {dmg} 伤害，击退 1 格并施加燃烧。" },
