...
export const DB_MONSTERS: MonsterData[] = [
  ...
  { id: 105, name: "祈祷哥", cost: 2, type: 'ranged', hp: 2000, atk: 50, ats: 1, range: 5, speed: 2.5, skill: 'recovery', skillCd: 0, race: "哥布林", role: "法师", 
    scale: 1, sx: 0, sy: 215, sw: 204, sh: 205, skillDesc: "回血连线：战斗开始时连线周围友军，自身攻击伤害时连线友军回血 2% 最大生命值。" },
  ...
  { id: 110, name: "帝国之盾", cost: 2, type: 'melee', hp: 3000, atk: 72, ats: 0.83, range: 1, speed: 2.5, skill: 'shield', skillCd: 6, race: "人类", 
    role: "坦克", scale: 1.0, sx: 204, sy: 425, sw: 204, sh: 205, skillDesc: "帝国铁盾：每 6s 给自己和相邻友方 5 层护盾。护盾减免 60% 伤害。" },
  ...
  { id: 113, name: "爆破大师", cost: 2, type: 'ranged', hp: 1700, atk: 102, ats: 0.74, range: 6, speed: 2.5, skill: 'explosive', skillCd: 0, race: "矿工", 
    role: "法师", scale: 1.0, sx: 0, sy: 625, sw: 204, sh: 200, skillDesc: "爆破普攻：普攻附带溅射效果，可同时攻击相邻的怪兽。" },
  { id: 114, name: "突突突矿工", cost: 2, type: 'ranged', hp: 1400, atk: 50, ats: 2.14, range: 5, speed: 2.5, skill: 'open_fire', skillCd: 0, race: "矿工", 
    role: "射手", scale: 1.0, sx: 210, sy: 625, sw: 204, sh: 205, skillDesc: "疯狂扫射：开局攻速提升 200%，攻击力提升 12，持续 2.5s。" },
  ...
  { id: 118, name: "塞雷", cost: 4, type: 'melee', hp: 2700, atk: 120, ats: 1, range: 1, speed: 2.5, skill: 'slash', skillCd: 4, race: "亚人", 
    role: "战士", scale: 0.93, sx: 225, sy: 824, sw: 204, sh: 205, skillCoeff: 1.6, skillDesc: "突进斩击：突进到目标身后造成 {dmg} 伤害，给自己1层盾，最多突进 3 次。" },
